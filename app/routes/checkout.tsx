...
export default function CheckoutPage() {
  ...
  return (
    // Added min-h-screen bg-white wrapper
        ...
        >
          <div className="sm:col-span-2">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900"
            />
            {errors.name && (
          ...
          <button
              type="submit"
              className="mt-5 w-full rounded-lg bg-gray-900 py-3 text-sm font-medium text-white hover:bg-gray-700"
            >
              Place Order
            </button>
          </Link>
